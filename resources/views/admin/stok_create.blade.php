...
<div class="admin-container">
    ...
    <main class="admin-main">
        <div class="admin-header">
            <h1 class="admin-title">➕ Tambah Produk Baru</h1>
        ...
        <div class="admin-content">
            <form action="{{ route('stok.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="nama" name="nama" placeholder="Contoh: Lipstick Matte Rose Pink" value="{{ old('nama') }}" required>
                    @error('nama')
                ...
                <div class="form-group">
                    ...
                    <select id="kategori" name="kategori" required>
                        ...
                        <option value="Fragrance" {{ old('kategori') == 'Fragrance' ? 'selected' : '' }}>Fragrance</option>
                        <option value="Haircare" {{ old('kategori') == 'Haircare' ? 'selected' : '' }}>Haircare</option>
                    </select>
                    @error('kategori')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="harga" name="harga" placeholder="Contoh: 85000" value="{{ old('harga') }}" required>
                    @error('harga')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="stok" name="stok" placeholder="Contoh: 50" value="{{ old('stok') }}" required>
                    @error('stok')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="rating" name="rating" placeholder="Contoh: 4.8" min="0" max="5" step="0.1" value="{{ old('rating', 0) }}">
                    @error('rating')
                        <div class="error-message">{{ $message }}</div>
                    @enderror
                </div>
